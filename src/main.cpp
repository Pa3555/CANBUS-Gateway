 ...
 *
 * Dual CAN bus gateway with WiFi connectivity and CANopen joystick support
 *
 * Features:
 * - Dual CAN bus (2 independent channels)
 * - WiFi AP/Client modes
 * - CAN bus sniffing
 * - CANopen SDO/PDO support for joysticks
